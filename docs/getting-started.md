...
This guide will walk you through setting up **RecordRanger** on your local machine or server using Node.js and MongoDB.
...
```bash
pm2 start app.js --name recordranger
```

RecordRanger should now be running at http://localhost:3099.
